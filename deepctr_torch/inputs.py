...
from fl_libs.init import init_emb
...
def create_embedding_matrix(feature_columns, init_std=0.0001, linear=False, sparse=False, device='cpu'):
    ...
    for tensor in embedding_dict.values():
        if isinstance(tensor, nn.Embedding):
            init_emb(tensor)
...
# TODO: This can be merged with embedding_lookup
def varlen_embedding_lookup(X, embedding_dict, sequence_input_dict, varlen_sparse_feature_columns, return_feat_list=()):
    ...
    for fc in varlen_sparse_feature_columns:
        ...
        if (len(return_feat_list) == 0 or feature_name in return_feat_list):
            ...
            varlen_embedding_vec_dict[feature_name] = emb
